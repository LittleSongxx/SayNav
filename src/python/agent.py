...
class Agent:
    ...
    def __init__(self, controller, params):
        ...
        if self.nav_policy_type == 1:
            ...
            if self.reachable_positions is None or len(self.reachable_positions) == 0:
                raise RuntimeError("GetReachablePositions returned None or empty. The scene may not be properly loaded or the house geometry is invalid.")
