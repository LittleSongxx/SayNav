...
def pipeline(house_instance, controller, objects, params):
    ...
    openai_base_url = params['General'].get('openai_base_url', '')
    llm_planner = LLMPlanner(enable_room_tracking = params['General']['enable_llm_room_tracking'], model_name=params['General']['llm_model_name'], openai_key=params['General']['openai_key'], openai_base_url=openai_base_url)
